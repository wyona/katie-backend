...
* Startup Katie: <em>java -jar target/askkatie-webapp-1.380.0-SNAPSHOT.war</em>
...
* Tag image:
    * docker tag katie wyona/katie:1.380.0
    * docker tag katie wyona/katie-mac-m:1.380.0
    * docker tag katie wyona/katie-with-prefix:1.380.0
* Push image to Docker Hub:
    * docker login -u USERNAME -p PASSWORD docker.io && docker push wyona/katie:1.380.0
    * docker login -u USERNAME -p PASSWORD docker.io && docker push wyona/katie-mac-m:1.380.0
* Run image:
...
* git tag -a v1.380.0 -m "Release v1.380.0"
* git push origin v1.380.0
