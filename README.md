...
* Startup Katie: <em>java -jar target/askkatie-webapp-1.373.0-SNAPSHOT.war</em>
...
* Tag image:
    * docker tag katie wyona/katie:1.373.0
    * docker tag katie wyona/katie-mac-m:1.373.0
    * docker tag katie wyona/katie-with-prefix:1.373.0
* Push image to Docker Hub: docker login -u USERNAME -p PASSWORD docker.io && docker push wyona/katie:1.373.0
* Run image:
