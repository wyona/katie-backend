...
To pull the most recent Katie image from [Docker Hub](https://hub.docker.com/r/wyona/katie/tags) (with prefix [/katie](https://hub.docker.com/r/wyona/katie-with-prefix/tags)) and run Katie locally, please follow the steps below
