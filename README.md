...
To pull the most recent Katie image from [Docker Hub](https://hub.docker.com/r/wyona/katie/tags) and run Katie locally, please follow the steps below
...
* Startup Katie: <em>java -jar target/askkatie-webapp-1.358.0-SNAPSHOT.war</em>
...
* Tag image: docker tag katie wyona/katie:1.358.0
* Push image to Docker Hub: docker login -u USERNAME -p PASSWORD docker.io && docker push wyona/katie:1.358.0
* Run image:
