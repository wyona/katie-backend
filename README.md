...
To pull the most recent Katie image from [Docker Hub](https://hub.docker.com/r/wyona/katie/tags) (with prefix [/katie](https://hub.docker.com/repository/docker/wyona/katie-with-prefix/tags) or for [Mac M1 or higher](https://hub.docker.com/r/wyona/katie-mac-m/tags)) and run Katie locally, please follow the steps below
