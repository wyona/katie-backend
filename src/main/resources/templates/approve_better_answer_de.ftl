...
<html lang="de">
<head>
    <@components.globalHead title="Bessere Antwort überprüfen und genehmigen"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        <h1 style="margin: 32px 0 0;">Bessere Antwort überprüfen und genehmigen</h1>
                                        <p style="margin: 16px 0 0;">
                                            Ein Benutzer hat eine bessere Antwort auf die folgende Frage gegeben <span
