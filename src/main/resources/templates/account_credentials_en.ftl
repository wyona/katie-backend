...
<html lang="en">
<head>
    <@components.globalHead title="Account credentials"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        We have created a Katie account for you:
                                        </p>
                                        <p style="margin: 16px 0 0;">
                                            U: ${username}
                                            <#if password??><br/>P: ${password}<#else></#if>
                                        </p>
                                        <p style="margin: 16px 0 0;">
                                        Please login at <a href="${katie__base_url}">${katie__base_url}</a>
                                        </p>
