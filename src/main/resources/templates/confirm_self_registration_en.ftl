...
<html lang="en">
<head>
    <@components.globalHead title="Please confirm your email address"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        <h1 style="margin: 32px 0 0;">Welcome to Katie!</h1>
                                        <p style="margin: 16px 0 0;">
                                        Thank you for registering with Katie, ${firstname}.
                                        </p>
                                        <p style="margin: 16px 0 0;">
                                        Please confirm your email address to complete your account setup:  <a href="${katie__base_url}/#/confirm-registration?token=${token}">${katie__base_url}/#/confirm-registration</a>
                                        </p>
