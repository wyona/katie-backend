...
<html lang="en">
<head>
    <@components.globalHead title="Join your team"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        <h1 style="margin: 32px 0 0;">Join your team at Katie</h1>
                                        <p style="margin: 16px 0 0;">
                                            ${host_name} (${host_email}) invited you to use Katie together in a domain called <strong>${domain_name}</strong>.</p>
                                        <table role="presentation"
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; padding-bottom: 15px;">
                                                    <table role="presentation"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <@components.buttonFilled link="${join_link}" text="Join now"/>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
