...
<html lang="en">
<head>
    <@components.globalHead title="Zugangsdaten zum Konto"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        Wir haben für Dich ein Katie-Konto erstellt:
                                        </p>
                                        <p style="margin: 16px 0 0;">
                                            U: ${username}
                                        ...
                                        <p style="margin: 16px 0 0;">
                                        Bitte anmelden bei <a href="${katie__base_url}">${katie__base_url}</a>
                                        </p>
