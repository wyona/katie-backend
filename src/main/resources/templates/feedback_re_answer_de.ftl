...
<html lang="en">
<head>
    <@components.globalHead title="Feedback zu einer Antwort"/>
</head>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        ...
                                        <h1 style="margin: 32px 0 0;">Neues Antwort Feedback</h1>
                                        <p style="margin: 16px 0 0;">
                                            Ein Benutzer hat ein <span style="font-weight: bold"><#if feedback_positive == true>positives<#else>negatives</#if></span> Feedback für die Antwort auf die folgende Frage gegeben <span
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; padding-bottom: 15px;">
                                                    <table role="presentation"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <@components.buttonFilled link="${question_answer_link}" text="Mehr Informationen"/>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <p style="margin: 16px 0 0;">
                                            Alle Einsichten <a href="${insights_link}">hier</a> ansehen
                                        </p>
                                        <p style="margin: 16px 0 0;">Danke, <br/>Team Katie</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
