...
public class ContextService {
     ...
     */
    public boolean isAuthorized(String domainId, String jwtToken, String endpoint, String scope) {
        if (jwtToken != null) {
            ...
            log.warn("No access token provided, therefore check whether user is signed in ...");
