    ...
    private String getEmailBody(String message) {
        ...
        try {
            ...
            if (completionImpl.equals(CompletionImpl.MISTRAL_AI)) {
                completedText = generateMistralCloud.getCompletion(promptMessages, null, mistralAIModel, temperature, mistralAIKey);
            } else {
                completedText = generateOllama.getCompletion(promptMessages, null, ollamaModel, temperature, null);
            }
