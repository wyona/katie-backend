...
*/
    ...
    private String getSlackModal(String callbackId, String title, String submitLabel, String blockId, String inputLabel, String placeholder, String hint, String channelId) {
        ...
        modal.append("\"type\": \"modal\",");
        modal.append("\"callback_id\": \"" + callbackId + "\",");

        modal.append("\"title\": {");
        modal.append("\"type\": \"" + FORMAT_PLAIN_TEXT + "\",");
        modal.append("\"text\": \"" + title + "\"");
        modal.append("},");

        modal.append("\"submit\": {");
        modal.append("\"type\": \"" + FORMAT_PLAIN_TEXT + "\",");
        modal.append("\"text\": \"" + submitLabel + "\"");
        modal.append("},");
        ...
        modal.append("\"block_id\": \"" + blockId + "\",");

        // INFO: Input element
        modal.append("\"element\": {");
        modal.append("\"type\": \"plain_text_input\",");
        modal.append("\"action_id\": \"single_line_input\",");
        //modal.append("\"response_url_enabled\": true,");
        modal.append("\"placeholder\": {");
        modal.append("\"type\": \"" + FORMAT_PLAIN_TEXT + "\",");
        modal.append("\"text\": \"" + placeholder + "\"");
        modal.append("}");
        modal.append("},");
        ...
        modal.append("\"label\": {");
        modal.append("\"type\": \"" + FORMAT_PLAIN_TEXT + "\",");
        modal.append("\"text\": \"" + inputLabel + "\"");
        modal.append("},");

        // INFO: Hint
        modal.append("\"hint\": {");
        modal.append("\"type\": \"" + FORMAT_PLAIN_TEXT + "\",");
        modal.append("\"text\": \"" + hint + "\"");
        modal.append("}");
        ...
        modal.append("\"text\": \"Pick a channel from the dropdown list\",");
        modal.append("},");
        modal.append("\"accessory\": {");
        modal.append("\"action_id\": \"select_id\",");
        modal.append("\"type\": \"channels_select\",");
        modal.append("\"response_url_enabled\": true,"); // https://api.slack.com/surfaces/modals/using#modal_response_url
        modal.append("\"initial_channel\": \"" + channelId + "\",");
        modal.append("\"placeholder\": {");
        modal.append("\"type\": \"plain_text\",");
        modal.append("\"text\": \"Select a channel\"");
        modal.append("}");
        modal.append("}");
        modal.append("}");
...
*/
        ...
        try {
            ...
            if (count < numberOfQuestionsLimit) { // TODO: Get limit from domain configuration
                ...
                List<ResponseAnswer> answers = qaService.getAnswers(analyzedMessage.getMessage(), classifications, messageId, domain, dateSubmitted, remoteAddress, ChannelType.SLACK, channelRequestId, 2, 0, checkAuthorization, null,false);
