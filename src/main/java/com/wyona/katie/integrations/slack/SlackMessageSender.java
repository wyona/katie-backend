...
*/
        ...
        try {
            ...
            if (count < numberOfQuestionsLimit) { // TODO: Get limit from domain configuration
                ...
                List<ResponseAnswer> answers = qaService.getAnswers(analyzedMessage.getMessage(), false, classifications, messageId, domain, dateSubmitted, remoteAddress, ChannelType.SLACK, channelRequestId, 2, 0, checkAuthorization, null,false, false);
