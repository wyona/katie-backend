...
public class AskCommand implements SlashCommand {
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        try {
            ...
            List<ResponseAnswer> answers = qaService.getAnswers(question,false,null, messageId, domain, new Date(), null, ChannelType.UNDEFINED, channelRequestId, -1, -1, checkAuthorization, null, false, false);
