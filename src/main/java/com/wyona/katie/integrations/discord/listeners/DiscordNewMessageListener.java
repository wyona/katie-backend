...
public class DiscordNewMessageListener extends CommonMessageSender {
    ...
    public Mono<Message> handle(MessageCreateEvent event) {
        ...
        try {
            ...
            List<ResponseAnswer> answers = qaService.getAnswers(question, false, classifications, messageId, domain, new Date(), remoteAddress, ChannelType.DISCORD, channelRequestId, -1, -1, true, null, false, false);
