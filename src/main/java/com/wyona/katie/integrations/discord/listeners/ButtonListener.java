...
public class ButtonListener extends CommonMessageSender {
    ...
    private String getSeeMoreAnswers(Context domain, String question) {
        ...
        try {
            ...
            List<ResponseAnswer> answers = qaService.getAnswers(question, classifications, messageId, domain, new Date(), remoteAddress, ChannelType.DISCORD, channelRequestId, limit, offset, true, null,false);
