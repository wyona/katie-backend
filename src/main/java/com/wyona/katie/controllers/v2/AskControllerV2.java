...
public class AskControllerV2 {
    ...
    private ResponseEntity<?> getAnswers(String question,
        ...
        try {
            ...
            java.util.List<ResponseAnswer> responseAnswers = qaService.getAnswers(question, false, classifications, messageId, domain, dateSubmitted, AskController.getRemoteAddress(request), ChannelType.UNDEFINED, null, _limit, _offset, true, answerContentType, includeFeedbackLinks, false);
